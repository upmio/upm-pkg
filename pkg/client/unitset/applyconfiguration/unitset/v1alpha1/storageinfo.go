...
// apply.
func StorageInfo() *StorageInfoApplyConfiguration {
	return &StorageInfoApplyConfiguration{}
}

// WithVolumes adds the given value to the Volumes field in the declarative configuration
// and returns the receiver, so that objects can be build by chaining "With" function invocations.
// If called multiple times, values provided by each call will be appended to the Volumes field.
func (b *StorageInfoApplyConfiguration) WithVolumes(values ...*VolumeRequirementApplyConfiguration) *StorageInfoApplyConfiguration {
	for i := range values {
		if values[i] == nil {
