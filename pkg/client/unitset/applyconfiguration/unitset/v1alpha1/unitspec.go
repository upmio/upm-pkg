...
func (b *UnitSpecApplyConfiguration) WithEnv(values ...v1.EnvVar) *UnitSpecApplyConfiguration {
	for i := range values {
...
func (b *UnitSpecApplyConfiguration) WithResources(value *ResourcesApplyConfiguration) *UnitSpecApplyConfiguration {
	b.Resources = value
	return b
}
